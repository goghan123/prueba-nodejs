...
// let nombreMio = "Nico";
// console.log("Mi nombre es " + nombreMio + ".");

//function duplicacion(numero1) {
  //  return numero1 * 2;
    
//};


//console.log(duplicacion(10));
...
/*
function hacerPresentacion(nombreMio) {
    return nombreMio + ", ese es mi nombre.";
    };

console.log(hacerPresentacion("Nico"));
*/

/*
function saludoAUsuario(inputNombre) {
    alert("¡Hola, " + inputNombre + "");
}

let nombre2 = prompt("Por favor, ingrese su nombre: ");
saludoAUsuario(nombre2);
*/
...
/*
function compuDesgraciada(nombreVictima) {
    alert("Hola, " + nombreVictima);
    let respuesta1 = prompt("¿Querés jugar un juego?");
    alert("¿" + respuesta1 + "? ¿Qué clase de respuesta es esa, " + nombreVictima + " tonta?");
    alert("Andate de acá " + nombreVictima + "... y que tengas un buen día =) ");
}

let nombre1 = prompt("Ingrese su nombre: ");
compuDesgraciada(nombre1);
...
/*
function sumarDosValores(valor1ParaSuma, valor2ParaSuma) {
    return ("El resultado de su suma es: " + (Number(valor1ParaSuma) + Number(valor2ParaSuma)) + ".");
}

let presentacionParaSumar1 = Number(prompt("Indique el valor 1 para la suma: "));
let presentacionParaSumar2 = Number(prompt("Indique el valor 2 para la suma: "));

console.log(sumarDosValores(presentacionParaSumar1,presentacionParaSumar2));



function restarDosValores(valor1ParaResta, valor2ParaResta) {
    console.log("El resultado de su resta es: " + (Number(valor1ParaResta) - Number(valor2ParaResta)) + ".");
}
let presentacion1ParaRestar = prompt("Ingrese el valor al que va a restar: ");
let presentacion2ParaRestar = prompt("Ingrese el valor que va a restar al valor 1: ");

restarDosValores(presentacion1ParaRestar,presentacion2ParaRestar);
*/
...
no se ingresó operación válida

function resultado
if operador m d s r "su resultado es..."

valor 1 ingresar valor 1
operador ingresar operador
valor 2 ingresar valor 2
operador
resultado
*/
...
//////Calcu para cuatro funciones///////////
/*
function operador(numero1,operacionElegida,numero2){
    if(operacionElegida==="*"){
    ...
    if(operacionElegida==="/"){
        ...
        if(operacionElegida==="+"){
            ...
            if(operacionElegida==="-"){
                ...
                return("(no se ingresó una operación válida)");
            }
            }
                    }
                    }
    }
let valor1 = prompt("Ingrese valor 1 para su operación: ");
let operacion = prompt("¿Qué operación de las cuatro desea hacer, /, *, + o - ?");
let valor2 = prompt("Ingrese valor 2: ");
alert("El resultado es " + operador(valor1,operacion,valor2) + ".");
...
/*
function dato(nombreChabon) {
if (nombreChabon === "Nicolás"){
    alert("¡Hola, tocayo!")
}else{
    if(nombreChabon === "Carlos"){
        alert("¡Ah, como mi tío!")
    }else{
            alert("¡Hola " + nombreChabon + "!")
        }
    }
}
...
*/
/*
function stalker(edad){
    if (Number(edad) === 25) {
        alert("¡Como yoooo, como yooooo!")
    }else{
        if(Number(edad) >= 25) {
            alert("Ah, más grande que yo.")
        }else{
            if(Number(edad) <= 25){
               alert("Ah, más chico que yo.")
               }
        }
        }
    }
let edadUsuario = prompt("¡¡Hola, ¿qué edad tenés?!!");
stalker(edadUsuario);
...
function preguntarSiDocumento(documento){
        if(documento.toLowerCase() == "sí"){
        preguntarEdad();
    }else{
        if(documento.toLowerCase() == "no"){
        alert("Juera.")
    }else{
        alert("¿Vat?");
    }
...
let tieneDocumento = prompt("¿Tenés doc?");
preguntarSiDocumento(tieneDocumento);
*/

...
/*
let contador = 10;
function finalCountdown(contador){
while (Number(contador) > 1){
    (contador -= 1);
    console.log(contador);
}
}
finalCountdown(contador);
*/
/*
    Bucles for (para)
    ==========
...
//TAREA: calculadora de promedios
/*
let notasDelAlumno = [4, 5, 8, 2];
let sumador = 0;
    for (let i=0; i < notasDelAlumno.length; i++){
    sumador = sumador + notasDelAlumno[i];
    }
alert("El promedio de notas es " + (sumador / notasDelAlumno.length) + ("."));
*/
